...
#Region "-    Insert,delete,update   -"
    ...
    End Function
     Function UpdateByName(theLoaiSach As TheLoaiSach, theLoaiSachID As String) As Result
        If String.IsNullOrWhiteSpace(theLoaiSachID) Then Return New Result(False, "Mã thể loại không hợp lệ!", "")
        Return _theLoaiSachDAO.UpdateById(theLoaiSach, theLoaiSachID)
    End Function
    ...
    End Function
    Function DeleteByName(theLoaiSachId As String) As Result
        If String.IsNullOrWhiteSpace(theLoaiSachId) Then Return New Result(False, "Mã thể loại không hợp lệ!", "")
        Return _theLoaiSachDAO.DeleteById(theLoaiSachId)
    End Function
    ...
    End Function
    Function InsertMore(theLoaiSach As TheLoaiSach) As Result
        If Not theLoaiSach.ValidateTenTheLoaiSach() Then Return New Result(False, "Thông tin input không hợp lệ!", "")
        Return _theLoaiSachDAO.InsertOne(theLoaiSach)
    End Function
#End Region
...
#Region "-   Retrieve data  -"
    ...
    Public Function GetTenTheLoaiSachByID(ByRef tentheLoaiSach As String, maTheLoaiSach As String) As Result
        ...
        Return result
    End Function
    Public Function GetTenTheLoaiSachByName(ByRef tentheLoaiSach As String, maTheLoaiSach As String) As Result
        Dim result = _theLoaiSachDAO.GetTenTheLoaiSachByID(tentheLoaiSach, maTheLoaiSach)
        Return result
    End Function
    ...
    Public Function GetTheNextID(ByRef id As String) As Result
        ...
        Return result
    End Function
    Public Function GetTheNextLast(ByRef id As String) As Result
        id = String.Empty
        Dim result = _theLoaiSachDAO.GetTheLastId(id)
        id = If(String.IsNullOrWhiteSpace(id), 1, id + 1)
        Return result
